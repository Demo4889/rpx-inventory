return {
	Weapons = {
		['weapon_melee_knife_miner']                = { label = 'Miner Knife',                  description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_miner.png'},
		['weapon_melee_knife_jawbone']              = { label = 'Jawbone Knife',                description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_jawbone.png'},
		['weapon_melee_knife_vampire']              = { label = 'Vampire Knife',                description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_vampire.png'},
		['weapon_melee_knife_bear']                 = { label = 'Bear Knife',                   description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_bear.png'},
		['weapon_melee_knife_civil_war']            = { label = 'Civil War Knife',              description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_civil_war.png'},
		['weapon_melee_knife_trader']               = { label = 'Trader Knife',                 description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_trader.png'},
		['weapon_melee_knife_horror']               = { label = 'Horror Knife',                 description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_horror.png'},
		['weapon_melee_knife_rustic']               = { label = 'Rustic Knife',                 description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife_rustic.png'},
		['weapon_melee_knife']                      = { label = 'Knife',                        description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_knife.png'},
		['weapon_melee_torch_crowd']                = { label = 'Crowd Torch',                  description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_torch_crowd.png'},
		['weapon_melee_torch']                      = { label = 'Torch',                        description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_torch.png'},
		['weapon_melee_broken_sword']               = { label = 'Broken Sword',                 description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_broken_sword.png'},
		['weapon_melee_machete']                    = { label = 'Machete',                      description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_machete.png'},
		['weapon_melee_machete_collector']          = { label = 'Collector Machete',            description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_machete_collector.png'},
		['weapon_melee_hammer']                     = { label = 'Hammer',                       description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hammer.png'},
		['weapon_melee_cleaver']                    = { label = 'Cleaver',                      description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_cleaver.png'},
		['weapon_melee_lantern']                    = { label = 'Lantern',                      description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_lantern.png'},
		['weapon_melee_davy_lantern']               = { label = 'Davy Lantern',                 description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_davy_lantern.png'},
		['weapon_melee_lantern_electric']           = { label = 'Electric Lantern',             description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_lantern_electric.png'},
		['weapon_melee_lantern_halloween']          = { label = 'Halloween Lantern',            description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_lantern_halloween.png'},
		['weapon_melee_hatchet']                    = { label = 'Hatchet',                      description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hatchet.png'},
		['weapon_melee_hatchet_hewing']             = { label = 'Hewing Hatchet',               description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hatchet_hewing.png'},
		['weapon_melee_ancient_hatchet']            = { label = 'Ancient Hatchet',              description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_ancient_hatchet.png'},
		['weapon_melee_hatchet_hunter']             = { label = 'Hunter Hatchet',               description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hatchet_hunter.png'},
		['weapon_melee_hatchet_viking']             = { label = 'Viking Hatchet',               description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hatchet_viking.png'},
		['weapon_melee_hatchet_double_bit_rusted']  = { label = 'Rusted Double-Bit Hatchet',    description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hatchet_double_bit_rusted.png'},
		['weapon_melee_hatchet_double_bit']         = { label = 'Double-Bit Hatchet',           description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hatchet_double_bit.png'},
		['weapon_melee_hatchet_hunter_rusted']      = { label = 'Rusted Hunter Hatchet',        description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_melee_hatchet_hunter_rusted.png'},
		['weapon_revolver_doubleaction']            = { label = 'Colt M1873 Single Action',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_doubleaction.png'},
		['weapon_revolver_doubleaction_exotic']     = { label = 'Colt M1873 Single Action',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_doubleaction_exotic.png'},
		['weapon_revolver_doubleaction_gambler']    = { label = 'Colt M1892 Double-action',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_doubleaction_gambler.png'},
		['weapon_revolver_schofield_calloway']      = { label = 'Colt M1873 Single Action',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_schofield_calloway.png'},
		['weapon_revolver_schofield']               = { label = 'Colt M1873 Single Action',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_schofield.png'},
		['weapon_revolver_schofield_golden']        = { label = 'Colt M1873 Single Action',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_schofield_golden.png'},
		['weapon_revolver_cattleman']               = { label = 'Colt M1873 Single Action',     description = 'Placeholder',  weight = 250, durability = 100, image = 'weapon_revolver_cattleman.png'},
		['weapon_revolver_cattleman_mexican']       = { label = 'Steel Colt M1873',             description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_cattleman_mexican.png'},
		['weapon_revolver_lemat']                   = { label = 'LeMat Revolver',               description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_lemat.png'},
		['weapon_revolver_navy']                    = { label = 'Navy Revolver 1851',           description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_navy.png'},
		['weapon_revolver_navy_crossover']          = { label = 'Navy Revolver 1851',           description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_revolver_navy_crossover.png'},
		['weapon_pistol_volcanic']                  = { label = 'Volcanic Pistol',              description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_pistol_volcanic.png'},
		['weapon_pistol_mauser']                    = { label = 'Mauser C96',                   description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_pistol_mauser.png'},
		['weapon_pistol_mauser_drunk']              = { label = 'Mauser C96',                   description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_pistol_mauser_drunk.png'},
		['weapon_pistol_m1899']                     = { label = 'FN Browning M1900',            description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_pistol_m1899.png'},
		['weapon_pistol_semiauto']                  = { label = 'Borchardt C-93',               description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_pistol_semiauto.png'},
		['weapon_repeater_carbine']                 = { label = 'Spencer Model 1865',           description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_repeater_carbine.png'},
		['weapon_repeater_winchester']              = { label = 'Winchester Model 1866',        description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_repeater_winchester.png'},
		['weapon_repeater_henry']                   = { label = 'Henry Model 1860',             description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_repeater_henry.png'},
		['weapon_repeater_evans']                   = { label = 'Evans Repeating Rifle',        description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_repeater_evans.png'},
		['weapon_rifle_varmint']                    = { label = 'Winchester Model 1890',        description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_rifle_varmint.png'},
		['weapon_rifle_springfield']                = { label = 'Springfield Model 1873',       description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_rifle_springfield.png'},
		['weapon_rifle_boltaction']                 = { label = 'Springfield Model 1892',       description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_rifle_boltaction.png'},
		['weapon_rifle_elephant']                   = { label = 'Elephant Rifle',               description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_rifle_elephant.png'},
		['weapon_shotgun_sawedoff']                 = { label = 'Hammerless Shotgun 1883',      description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_shotgun_sawedoff.png'},
		['weapon_shotgun_doublebarrel_exotic']      = { label = 'Steel Hammer Shotgun 1878',    description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_shotgun_doublebarrel_exotic.png'},
		['weapon_shotgun_pump']                     = { label = 'Steel Hammer Shotgun 1878',    description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_shotgun_pump.png'},
		['weapon_shotgun_repeating']                = { label = 'Steel Hammer Shotgun 1878',    description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_shotgun_repeating.png'},
		['weapon_shotgun_semiauto']                 = { label = 'Browning Auto-5',              description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_shotgun_semiauto.png'},
		['weapon_shotgun_doublebarrel']             = { label = 'Colt Hammer Shotgun 1878',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_shotgun_doublebarrel.png'},
		['weapon_sniperrifle_rollingblock_exotic']  = { label = 'Steel Remmington M1867',       description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_sniperrifle_rollingblock_exotic.png'},
		['weapon_sniperrifle_carcano']              = { label = 'Carcano 1891 Short Rifle',     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_sniperrifle_carcano.png'},
		['weapon_sniperrifle_rollingblock']         = { label = 'Remmington M1867',             description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_sniperrifle_rollingblock.png'},
		['weapon_thrown_molotov']                   = { label = 'Molotov',                      description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_molotov.png'},
		['weapon_thrown_tomahawk_ancient']          = { label = 'Ancient Tomahawk',             description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_tomahawk_ancient.png'},
		['weapon_thrown_tomahawk']                  = { label = 'Tomahawk',                     description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_tomahawk.png'},
		['weapon_thrown_dynamite']                  = { label = 'Dynamite',                     description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_dynamite.png'},
		['weapon_thrown_throwing_knives']           = { label = 'Knives',                       description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_throwing_knives.png'},
		['weapon_thrown_bolas']                     = { label = 'Bolas',                        description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_bolas.png'},
		['weapon_thrown_poisonbottle']              = { label = 'Bolas',                        description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_poisonbottle.png'},
		['weapon_thrown_bolas_hawkmoth']            = { label = 'Bolas',                        description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_bolas_hawkmoth.png'},
		['weapon_thrown_bolas_ironspiked']          = { label = 'Bolas',                        description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_bolas_ironspiked.png'},
		['weapon_thrown_bolas_intertwined']         = { label = 'Bolas',                        description = 'Placeholder',  weight = 500, throwable = true, durability = 100, image = 'weapon_thrown_bolas_intertwined.png'},
		['weapon_kit_binoculars']                   = { label = 'Binoculars',                   description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_kit_binoculars.png'},
		['weapon_kit_camera']                       = { label = 'Camera',                       description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_kit_camera.png'},
		['weapon_kit_detector']                     = { label = 'Detector',                     description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_kit_detector.png'},
		['weapon_kit_camera_advanced']              = { label = 'Advanced Camera',              description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_kit_camera_advanced.png'},
		['weapon_kit_binoculars_improved']          = { label = 'Improved Binoculars',          description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_kit_binoculars_improved.png'},
		['weapon_kit_metal_detector']               = { label = 'Metal Detector',               description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_kit_metal_detector.png'},
		['weapon_bow']                              = { label = 'Bow',                          description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_bow.png'},
		['weapon_bow_improved']                     = { label = 'Improved Bow',                 description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_bow_improved.png'},
		['weapon_fishingrod']                       = { label = 'Fishing Rod',                  description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_fishingrod.png'},
		['weapon_lasso_reinforced']                 = { label = 'Reinforced Lasso',             description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_lasso_reinforced.png'},
		['weapon_lasso']                            = { label = 'Lasso',                        description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_lasso.png'},
		['weapon_moonshinejug_mp']                  = { label = 'Moonshine Jug',                description = 'Placeholder',  weight = 500, durability = 100, image = 'weapon_moonshinejug_mp.png'},
	},
	...
	Ammo = {
		...
		["ammo_arrow_confusion"]                = { label = "Confusion Arrow",                  description = "Arrows that will confuse your prey",     weight = 1.0, ammotype = `AMMO_ARROW_CONFUSION`,              amount = '5', 	image = "ammo_arrow_confusion.png"},
		["ammo_arrow_disorient"]                = { label = "Disorient Arrow",                  description = "Arrows that will disorient your prey",   weight = 1.0, ammotype = `AMMO_ARROW_DISORIENT`,              amount = '5', 	image = "ammo_arrow_disorient.png"},
		["ammo_arrow_drain"]                    = { label = "Draining Arrow",                   description = "Arrows that will drain your prey",       weight = 1.0, ammotype = `AMMO_ARROW_DRAIN`,                  amount = '5', 	image = "ammo_arrow_drain.png"},
		["ammo_arrow_dynamite"]                 = { label = "Dynamite Arrow",                   description = "Arrows that will go boom",               weight = 1.0, ammotype = `AMMO_ARROW_DYNAMITE`,               amount = '5', 	image = "ammo_arrow_dynamite.png"},
		["ammo_arrow_fire"]                     = { label = "Fire Arrow",                       description = "Arrows that will start a fire",          weight = 1.0, ammotype = `AMMO_ARROW_FIRE`,                   amount = '5', 	image = "ammo_arrow_fire.png"},
		["ammo_arrow_improved"]                 = { label = "Improved Arrow",                   description = "Arrows that are improved",               weight = 1.0, ammotype = `AMMO_ARROW_IMPROVED`,               amount = '5', 	image = "ammo_arrow_improved.png"},
		["ammo_arrow_poison"]                   = { label = "Poison Arrow",                     description = "Arrows that will poison your prey",      weight = 1.0, ammotype = `AMMO_ARROW_POISON`,                 amount = '5', 	image = "ammo_arrow_poison.png"},
		["ammo_arrow_small_game"]               = { label = "Small Game Arrow",                 description = "Arrows for small game",                  weight = 1.0, ammotype = `AMMO_ARROW_SMALL_GAME`,             amount = '5', 	image = "ammo_arrow_small_game.png"},
		["ammo_arrow_tracking"]                 = { label = "Tracking Arrow",                   description = "Arrows to track your prey",              weight = 1.0, ammotype = `AMMO_ARROW_TRACKING`,               amount = '5', 	image = "ammo_arrow_tracking.png"},
		["ammo_arrow_trail"]                    = { label = "Trailing Arrow",                   description = "Arrows to trail your prey",              weight = 1.0, ammotype = `AMMO_ARROW_TRAIL`,                  amount = '5', 	image = "ammo_arrow_trail.png"},
		["ammo_arrow_wound"]                    = { label = "Wounding Arrow",                   description = "Arrows to wound your prey",              weight = 1.0, ammotype = `AMMO_ARROW_WOUND`,                  amount = '5', 	image = "ammo_arrow_wound.png"},
		["ammo_pistol_normal"]                  = { label = "Bullet",                           description = "Pistol Cartridges",              		weight = 1.0, ammotype = `AMMO_PISTOL`,                       amount = '30', 	image = "ammo_bullet_normal.png"},
		["ammo_pistol_express"]                 = { label = "Express Bullet",                   description = "Pistol Cartridges - Express",            weight = 1.0, ammotype = `AMMO_PISTOL_EXPRESS`,               amount = '30', 	image = "ammo_bullet_express.png"},
		["ammo_pistol_explosive"]               = { label = "Explosive Bullet",                 description = "Pistol Cartridges - Explosive",      	weight = 1.0, ammotype = `AMMO_PISTOL_EXPRESS_EXPLOSIVE`,     amount = '30', 	image = "ammo_bullet_explosive.png"},
		["ammo_pistol_high_velocity"]           = { label = "High Velocity Bullet",             description = "Pistol Cartridges - High Velocity",      weight = 1.0, ammotype = `AMMO_PISTOL_HIGH_VELOCITY`,         amount = '30', 	image = "ammo_bullet_high_velocity.png"},
		["ammo_pistol_split_point"]             = { label = "Split Point Bullet",               description = "Pistol Cartridges - Split Point",        weight = 1.0, ammotype = `AMMO_PISTOL_SPLIT_POINT`,           amount = '30', 	image = "ammo_bullet_split_point.png"},
		["ammo_repeater_normal"]                = { label = "Bullet",                           description = "Arrows to trail your prey",              weight = 1.0, ammotype = `AMMO_REPEATER`,                     amount = '60', 	image = "ammo_bullet_normal.png"},
		["ammo_repeater_express"]               = { label = "Express Bullet",                   description = "Arrows for small game",                  weight = 1.0, ammotype = `AMMO_REPEATER_EXPRESS`,             amount = '60', 	image = "ammo_bullet_express.png"},
		["ammo_repeater_explosive"]             = { label = "Explosive Bullet",                 description = "Arrows that will poison your prey",      weight = 1.0, ammotype = `AMMO_REPEATER_EXPRESS_EXPLOSIVE`,   amount = '60', 	image = "ammo_bullet_explosive.png"},
		["ammo_repeater_high_velocity"]         = { label = "High Velocity Bullet",             description = "Arrows to track your prey",              weight = 1.0, ammotype = `AMMO_REPEATER_HIGH_VELOCITY`,       amount = '60', 	image = "ammo_bullet_high_velocity.png"},
		["ammo_repeater_split_point"]           = { label = "Split Point Bullet",               description = "Arrows to wound your prey",              weight = 1.0, ammotype = `AMMO_REPEATER_SPLIT_POINT`,         amount = '60', 	image = "ammo_bullet_split_point.png"},
		["ammo_revolver_normal"]                = { label = "Revolver Bullet",                  description = "Revolver Cartridges",              		weight = 1.0, ammotype = `AMMO_REVOLVER`,                     amount = '60', 	image = "ammo_bullet_normal.png"},
		["ammo_revolver_express"]               = { label = "Revolver Express Bullet",          description = "Revolver Cartridges - Express",          weight = 1.0, ammotype = `AMMO_REVOLVER_EXPRESS`,             amount = '60', 	image = "ammo_bullet_express.png"},
		["ammo_revolver_explosive"]             = { label = "Revolver Explosive Bullet",        description = "Revolver Cartridges - Explosive",      	weight = 1.0, ammotype = `AMMO_REVOLVER_EXPRESS_EXPLOSIVE`,   amount = '60', 	image = "ammo_bullet_explosive.png"},
		["ammo_revolver_high_velocity"]         = { label = "Revolver High Velocity Bullet",    description = "Revolver Cartridges - High Veolicty",    weight = 1.0, ammotype = `AMMO_REVOLVER_HIGH_VELOCITY`,       amount = '60', 	image = "ammo_bullet_high_velocity.png"},
		["ammo_revolver_split_point"]           = { label = "Revolver Split Point Bullet",      description = "Revolver Cartridges - Split Point",      weight = 1.0, ammotype = `AMMO_REVOLVER_SPLIT_POINT`,         amount = '60', 	image = "ammo_bullet_split_point.png"},
		["ammo_rifle_normal"]                   = { label = "Rifle Bullet",                     description = "Arrows to trail your prey",              weight = 1.0, ammotype = `AMMO_RIFLE`,                        amount = '30', 	image = "ammo_bullet_normal.png"},
		["ammo_rifle_express"]                  = { label = "Rifle Express Bullet",             description = "Arrows for small game",                  weight = 1.0, ammotype = `AMMO_RIFLE_EXPRESS`,                amount = '30', 	image = "ammo_bullet_express.png"},
		["ammo_rifle_explosive"]                = { label = "Rifle Explosive Bullet",           description = "Arrows that will poison your prey",      weight = 1.0, ammotype = `AMMO_RIFLE_EXPRESS_EXPLOSIVE`,      amount = '30', 	image = "ammo_bullet_explosive.png"},
		["ammo_rifle_high_velocity"]            = { label = "Rifle High Velocity Bullet",       description = "Arrows to track your prey",              weight = 1.0, ammotype = `AMMO_RIFLE_HIGH_VELOCITY`,          amount = '30', 	image = "ammo_bullet_high_velocity.png"},
		["ammo_rifle_split_point"]              = { label = "Rifle Split Point Bullet",         description = "Arrows to wound your prey",              weight = 1.0, ammotype = `AMMO_RIFLE_SPLIT_POINT`,            amount = '30', 	image = "ammo_bullet_split_point.png"},
		["ammo_rifle_elephant"]                 = { label = "Elephant Rifle Bullet",            description = "Arrows to wound your prey",              weight = 1.0, ammotype = `AMMO_RIFLE_ELEPHANT`,               amount = '4', 	image = "ammo_bullet_normal.png"},
